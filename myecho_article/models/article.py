...
class Article(BaseModel):
    ...
    user = models.OneToOneField(User, verbose_name='作者', related_name='user', on_delete=models.CASCADE)
    summary = models.CharField(verbose_name='摘要', help_text='文章摘要', max_length=255, null=True)
    like_count = models.IntegerField(verbose_name='点赞数', help_text='点赞数', default=0)
    comment_count = models.IntegerField(verbose_name='评论数', help_text='评论数', default=0)
